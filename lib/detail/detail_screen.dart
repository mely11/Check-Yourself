...
import 'package:flutter_todo/create/add_new.dart';
...
class _DetailScreenState extends State<DetailScreen>
  ...
  double buttonSize = 51.0;
  double buttonRadius = 51.0;
  double buttonPosition = 17.0;
  ...
  _startTransitionAnimation() {
    ...
    buttonSizeTween = Tween(begin: 51.0, end: width);
    buttonPositionTween = Tween(begin: 17.0, end: 0.0);
    buttonRadiusTween = Tween(begin: 51.0, end: 0.0);
